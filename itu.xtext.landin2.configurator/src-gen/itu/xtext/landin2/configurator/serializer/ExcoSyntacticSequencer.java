...
public class ExcoSyntacticSequencer extends AbstractSyntacticSequencer {

	protected ExcoGrammarAccess grammarAccess;
	...
	protected AbstractElementAlias match_Title___IDTerminalRuleCall_1_1_or_SpaceKeyword_1_0__a;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (ExcoGrammarAccess) access;
		...
		match_Title___IDTerminalRuleCall_1_1_or_SpaceKeyword_1_0__a = new AlternativeAlias(true, true, new TokenAlias(false, false, grammarAccess.getTitleAccess().getIDTerminalRuleCall_1_1()), new TokenAlias(false, false, grammarAccess.getTitleAccess().getSpaceKeyword_1_0()));
	}
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_Title___IDTerminalRuleCall_1_1_or_SpaceKeyword_1_0__a.equals(syntax))
				emit_Title___IDTerminalRuleCall_1_1_or_SpaceKeyword_1_0__a(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     name=ID (ambiguity) (rule end)
	 */
	protected void emit_Title___IDTerminalRuleCall_1_1_or_SpaceKeyword_1_0__a(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
